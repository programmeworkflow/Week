...
import { formatTelefone, formatCNPJ as fmtCNPJ2, formatDate as fmtDate2, parseISODate } from "@/lib/formatters";
                ...
                {isRegular && (() => {
                  ...
                  return (
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div><span className="text-xs font-medium text-muted-foreground">Data de Início</span><p className="text-sm text-foreground">{(() => { const d = parseISODate(p.start_date); return d ? format(d, "dd/MM/yyyy") : "—"; })()}</p></div>
                        <div><span className="text-xs font-medium text-muted-foreground">Data Limite</span><p className="text-sm text-foreground">{(() => { const d = parseISODate(p.due_date); return d ? format(d, "dd/MM/yyyy") : "—"; })()}</p></div>
                      </div>
                      <div>
